  ...
  run: async (client, message, args) => {
    ...
    const embed = new MessageEmbed()
      .setAuthor(
        ...
        'https://github.com/arktn/discord-giveaway-bot'
      )
      .setThumbnail(client.user.displayAvatarURL({ ...avatarOptions }))
      .setTitle('Help')
      .setURL('https://github.com/arktn/discord-giveaway-bot')
      .setColor('7289da')
      .setDescription(`You want to create a giveaway bot yourself?\n[Check out our Github page!](https://github.com/arktn/discord-giveaway-bot)`)
      .addFields({
